...
(function () {
  ...
  var performance = {
    ...
    now:
      window$1 && window$1.performance && window$1.performance.now
   ...
   * @return {boolean}
   */
  var inArray = Array.prototype.includes
    ? function (elem, array) {
  ...
  function typeEquiv(a, b) {
    ...
    if (aType !== bType) {
      ...
      return (
        (aType === "object" && BOXABLE_TYPES.has(objectType(a))
          ? a.valueOf()
          : a) ===
        (bType === "object" && BOXABLE_TYPES.has(objectType(b))
          ? b.valueOf()
          : b)
      );
    }
  ...
  var Logger = {
    warn: console$1
      ? Function.prototype.bind.call(console$1.warn || console$1.log, console$1)
      : function () {},
  };
    ...
    _createClass(Assert, [
      ...
      },
      {
        ...
        value: function ok(result, message) {
          if (!message) {
            message = result
              ? "okay"
              : "failed, expected argument to be truthy, was: ".concat(
                  dump.parse(result)
                );
          }
          this.pushResult({
      ...
      },
      {
        ...
        value: function notOk(result, message) {
          if (!message) {
            message = !result
              ? "okay"
              : "failed, expected argument to be falsy, was: ".concat(
                  dump.parse(result)
                );
          }
          this.pushResult({
      ...
      },
      {
        ...
        value: function throws(block, expected, message) {
          var _validateExpectedExce = validateExpectedExceptionArgs(
            expected,
            message,
            "throws"
          );
          ...
          if (typeof block !== "function") {
            currentTest.assert.pushResult({
              ...
              actual: block,
              message:
                "The value provided to `assert.throws` in " +
                '"' +
          ...
          if (actual) {
            var _validateException = validateException(
              actual,
              expected,
              message
            );
      ...
      },
      {
        ...
        value: function rejects(promise, expected, message) {
          var _validateExpectedExce3 = validateExpectedExceptionArgs(
            expected,
            message,
            "rejects"
          );
          var _validateExpectedExce4 = _slicedToArray(
            _validateExpectedExce3,
            2
          );
          ...
          return then.call(
            ...
            function handleRejection(actual) {
              var result;
              var _validateException3 = validateException(
                actual,
                expected,
                message
              );
  ...
  function emit(eventName, data) {
    ...
    var callbacks = originalCallbacks
      ? _toConsumableArray(originalCallbacks)
      : [];
  ...
  function on(eventName, callback) {
    if (typeof eventName !== "string") {
      ...
      throw new Error(
        '"'
          .concat(eventName, '" is not a valid event; must be one of: ')
          .concat(events, ".")
      );
  ...
  function done() {
    ...
    if (config.stats.testCount === 0 && config.failOnZeroTests === true) {
      ...
      if (config.filter && config.filter.length) {
        error = new Error(
          'No tests matched the filter "'.concat(config.filter, '".')
        );
      } else if (config.module && config.module.length) {
        error = new Error(
          'No tests matched the module "'.concat(config.module, '".')
        );
      } else if (config.moduleId && config.moduleId.length) {
        error = new Error(
          'No tests matched the moduleId "'.concat(config.moduleId, '".')
        );
      } else if (config.testId && config.testId.length) {
        error = new Error(
          'No tests matched the testId "'.concat(config.testId, '".')
        );
      } else {
  ...
  function Test(settings) {
    ...
    if (!this.skip && typeof this.callback !== "function") {
      ...
      throw new TypeError(
        "You must provide a callback to "
          .concat(method, '("')
    ...
    finish: function finish() {
      ...
      function logSuiteEnd(module) {
        ...
        while (modules.length) {
          ...
          modules.push.apply(
            modules,
            _toConsumableArray(nextModule.childModules)
          );
        }
      ...
      function moduleChainIdMatch(testModule, selectedId) {
        return (
          ...
          (testModule.parentModule &&
            moduleChainIdMatch(testModule.parentModule, selectedId))
        );
      }
  ...
  function allTestsExecuted(module) {
    return (
      module.testsRun + module.testsIgnored === collectTests(module).length
    );
  }
  ...
  var ConsoleReporter = /*#__PURE__*/ (function () {
    function ConsoleReporter(runner) {
      ...
      this.log =
        options.log || Function.prototype.bind.call(console$1.log, console$1);
      ...
      [
        ...
        },
        {
          ...
          value: function onSuiteEnd(suiteEnd) {
            ...
            this.perf.measure(
              "QUnit Test Suite: ".concat(suiteName),
  ...
  function prettyYamlValue(value) {
    ...
    if (typeof value === "string") {
      ...
      if (
        ...
        var trailingLinebreaks = trailingLinebreakMatch
      ...
      [
        ...
        },
        {
          ...
          value: function onError(error) {
            ...
            if (!this.ended) {
              ...
              this.log(
                $.red("not ok ".concat(this.testCount, " global failure"))
              );
              this.logError(error);
            }
        ...
        },
        {
          ...
          value: function onTestEnd(test) {
            ...
            if (test.status === "passed") {
              this.log(
                "ok "
                  .concat(this.testCount, " ")
                  .concat(test.fullName.join(" > "))
              );
            } else if (test.status === "skipped") {
              this.log(
                $.yellow(
                  "ok "
                    .concat(this.testCount, " # SKIP ")
                    .concat(test.fullName.join(" > "))
                )
              );
        ...
        },
        {
          ...
          value: function logAssertion(error, severity) {
            var out = "  ---";
            out += "\n  message: ".concat(
              prettyYamlValue(error.message || "failed")
            );
            out += "\n  severity: ".concat(
              prettyYamlValue(severity || "failed")
            );
  ...
  function onWindowError(details) {
    Logger.warn(
      "QUnit.onError is deprecated and will be removed in QUnit 3.0." +
    ...
    err.stack =
      details.stacktrace || details.fileName + ":" + details.lineNumber;
  ...
  QUnit.isLocal =
    window$1 && window$1.location && window$1.location.protocol === "file:";
  ...
  extend(QUnit, {
    ...
    extend: function extend$1() {
      Logger.warn(
        "QUnit.extend is deprecated and will be removed in QUnit 3.0." +
    ...
    (function (root, UMD) {
      ...
      function fuzzysortNew(instanceOptions) {
        var fuzzysort = {
          ...
          algorithmNoTypo: function algorithmNoTypo(
            searchLowerCodes,
            prepared,
            searchLowerCode
          ) {
          ...
          prepareNextBeginningIndexes: function prepareNextBeginningIndexes(
            target
          ) {
            var targetLen = target.length;
      ...
      var isNode =
        typeof commonjsRequire !== "undefined" && typeof window === "undefined";
      var MyMap =
        typeof Map === "function"
          ? Map
          : function () {
  ...
  (function () {
    ...
    function toolbarModuleFilter(beginDetails) {
      ...
      dropdownData = {
        ...
        isDirty: function isDirty() {
          return (
            _toConsumableArray(dropdownData.selectedMap.keys())
              .sort()
              .join(",") !==
    ...
    QUnit.on("runEnd", function (runEnd) {
      ...
      if (banner && (!abortButton || abortButton.disabled === false)) {
        banner.className =
          runEnd.status === "failed" ? "qunit-fail" : "qunit-pass";
      }
      if (abortButton) {
    ...
    if (usingPhantom) {
      console$1.warn(
        "Support for PhantomJS is deprecated and will be removed in QUnit 3.0."
      );
    }
    ...
    DiffMatchPatch.prototype.diffCleanupMerge = function (diffs) {
          ...
          case DIFF_EQUAL:
            ...
            if (countDelete + countInsert > 1) {
              if (countDelete !== 0 && countInsert !== 0) {
                ...
                var commonlength = this.diffCommonPrefix(
                  textInsert,
                  textDelete
                );
                if (commonlength !== 0) {
      ...
      while (pointer < diffs.length - 1) {
        if (
          ...
          var position = diffPointer.substring(
